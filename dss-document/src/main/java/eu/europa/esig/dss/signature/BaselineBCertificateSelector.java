...
public class BaselineBCertificateSelector extends CertificateReorderer {
    ...
    public List<CertificateToken> getCertificates() {
        ...
        CertificateSource trustedCertSources = certificateVerifier.getTrustedCertSource();
        // if true, trust anchor certificates (and upper certificates) are not included in the signature
        if (parameters.bLevel().isTrustAnchorBPPolicy() && !trustedCertSources.getCertificatePool().getCertificateTokens().isEmpty()) {
